...
data_dir = 'C:/Users/Kaggle/BMS/heng_clean/data'
data_dir_img = 'C:/Users/Kaggle/BMS/bms-molecular-translation'
...
class YNakamaTokenizer(object):
    ...
    def __init__(self, is_load=True):
        ...
        if is_load:
            ...
            #self.stoi = read_pickle_from_file('C:/Users/Kaggle/BMS/heng_clean/data/Pseudo_labels/tokenizer.stoi.pickle')
