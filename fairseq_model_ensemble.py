...
class CNN(nn.Module):
    def __init__(self,):
        ...
        e = tnt_s_patch16_224(pretrained=False)
...
class CNN_448(nn.Module):
    def __init__(self,):
        super(CNN_448, self).__init__()
...
class CNN_512(nn.Module):
    def __init__(self,):
        super(CNN_512, self).__init__()
...
class Net_448(nn.Module):

    def __init__(self,):
        super(Net_448, self).__init__()
        self.cnn = CNN_448()
        self.image_encode = nn.Identity()
        self.ens= True
...
class Net_512(nn.Module):

    def __init__(self,):
        super(Net_512, self).__init__()
        self.cnn = CNN_512()
        self.image_encode = nn.Identity()
        self.ens= True
