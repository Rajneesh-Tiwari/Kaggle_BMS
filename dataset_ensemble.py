...
class BmsDataset_448_512(Dataset):
...
#        print("Img shape",image.shape)
        image_448 = cv2.resize(image, dsize=(448,448), interpolation=cv2.INTER_LINEAR)
        image_512 = cv2.resize(image, dsize=(512,512), interpolation=cv2.INTER_LINEAR)
